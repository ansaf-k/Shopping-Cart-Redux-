...
const Navbar = ({ onSearchChange }) => {
  ...
  const cart = useSelector((state) => state.cartDetails.product)
  ...
  return (
    <nav className="sticky z-30 top-0 w-full bg-emerald-900 bg-opacity-80 backdrop-blur-sm text-white shadow-lg">
